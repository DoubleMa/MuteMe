...
namespace DoubleMa.INI {
    ...
    internal class XSectionWithComment : XElementWithComment {
        ...
        public XSectionWithComment(IINILoader loader, string tag, string comment = null) : base(tag, comment) {
    ...
    internal class XKeyWithComment<T> : XElementWithComment where T : IComparable, IConvertible {
        ...
        public XKeyWithComment(IINILoader loader, XSectionWithComment xSectionWithComment, string key, T[] acceptedValues, T defaultValue, string comment = null, string tag = "add") : base(tag, comment) {
        ...
        public XKeyWithComment(IINILoader loader, XSectionWithComment xSectionWithComment, string key, T defaultValue, string comment = null, string tag = "add") : base(tag, comment) {
            SectionWithComment = xSectionWithComment;
            Key = key;
            DefaultValue = defaultValue;
            StrValue = loader.GetValueOrCreate(this);
